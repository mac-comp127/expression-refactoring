...
/**
 * These are exercises to practice refactoring.
 */
...
public class MessyExpressions {
     ...
     *       literals `true` or `false` in your code at all.
     */
     ...
     *
     * YOUR TASK: First, make a copy of this code as it is, and comment out the copy.
     *   Then split each of the 4 steps into its own intermediate variable:
     ...
     *
     * Look at the original code, and how it looks after your refactoring. Dicuss
     * with your partner: what are the tradeoffs here? What might each of the two
     * approaches be better?
     */
